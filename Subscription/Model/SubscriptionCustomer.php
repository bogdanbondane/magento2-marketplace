...
class SubscriptionCustomer extends \Magento\Framework\Model\AbstractModel implements GridInterface
{
     ...
     * CMS page cache tag.
     */
    const CACHE_TAG = 'worldnettps_subscription_customer_records';

    /**
     * @var string
     */
    protected $_cacheTag = 'worldnettps_subscription_customer_records';
     ...
     * @var string
     */
    protected $_eventPrefix = 'worldnettps_subscription_customer_records';
    ...
    {
        $this->_init('WorldnetTPS\Subscription\Model\ResourceModel\SubscriptionCustomer');
    }
    /**
     * Get EntityId.
     *
